			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('The site is under construction.')
							])),
						A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('https://media.giphy.com/media/2ij1QxLNTl7hFQzj8M/giphy.gif')
							]),
						_List_Nil)
					]))
			]),
